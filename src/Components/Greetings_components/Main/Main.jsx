       ...
       <div className="section-parent">
        ...
        <div className="text-section">
         ...
         <div className="boxses">
                       ...
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1725344322.jpg" alt="" />
                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1715165601.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1715927230.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1715165233.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/news/1706874196.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHOSRTffxVLxU0hBOVg24zQjB78aeBMnJT5A&s" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1715926278.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1720709678.jpg" alt="" />

                       </div>
                       <div className="box">
                       <img src="https://safiabakery.uz/uploads/products/362_1715173387.jpg" alt="" />
